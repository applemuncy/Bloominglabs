    ...
    def send_raw(self, string):
        ...
        try:
            if self.ssl:
                ...
                self.socket.send(string.encode('ascii') + b'\r\n')
            if DEBUG:
...
numbered_events = []
for k, v in numeric_events.items():
    numbered_events.append(v)

all_events = generated_events + protocol_events + numbered_events
